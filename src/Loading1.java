...
public class Loading1 extends javax.swing.JFrame {
    public Loading1() {
        ...
        Thread ob = new Thread(() -> {
            try {
                ...
                Logger.getLogger(Loading1.class.getName()).log(Level.SEVERE, null, e);
            }
        });
        ob.start();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/MIT-WPU.png"))); // NOI18N
        jLabel1.setToolTipText("");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 770));
